...
```{r}
my_df <- data.frame(
  Person = c("Alice", "Bob", "Charlie", "Densie", "Erin", "Frank", "Gisele", "Harry", "Zachary", "Aren", "Mike", "Hannah"),
  Preference = c("Twitter", "Facebook", "Twitter", "Instagram", "Facebook", "Twitter", "Twitter", "Instagram", "Threads", "Snapchat", "TikTok", "TikTok")
)
  users = nrow(my_df)
  twitterUsers = my_df[my_df$Preference=="Twitter",]
  giselePref = my_df[7, 2]
  ...
  my_func <- function(){
    for(i in my_vec){
      if (i > 5){
        ...
        print("This elemnt is NOT greater than 5!")
      }
